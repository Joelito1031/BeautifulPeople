...
try{
  $retrieve_dispatcher_list = $connection->prepare("SELECT ID, FirstName, MiddleName, LastName, Suffix, Contact, PIN, OnDuty, Profile FROM dispatchers ORDER BY FirstName");
