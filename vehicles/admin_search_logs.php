...
try{
  if(isset($_POST['data'])){
    ...
    $retrieve_logs = $connection->prepare("SELECT logs.LogId, logs.Directory, logs.Vehicle, logs.Passengers, logs.Route, logs.LogDate, logs.LogTime,
                                           ...
                                           registered_vehicles.DContact, registered_vehicles.DAddress FROM logs INNER JOIN registered_vehicles ON logs.Vehicle = :searched AND registered_vehicles.PlateNo = :searched");
    $retrieve_logs->bindParam(":searched", $searched);
